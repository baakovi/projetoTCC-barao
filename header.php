    ...
    <nav class="py-3" style="background-color: #0B161E;">
        ...
        <header class="m-3">
            <div class="container-fluid d-flex flex-wrap justify-content-center">
                ...
                <!-- component -->
                <form action="./admin/pesquisa.php" method="GET">
                    <div>

                        <div class="p-2 py-6 search-input">

                            <input class="text-input" type="search" placeholder="Pesquisar..." aria-label="Search">
        ...
        <div class="container-fluid d-flex flex-wrap" style="justify-content: space-around;">
            ...
            <ul class="nav">
                ...
                <div class="Shopping">
                    <li class="nav-item nav-link" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop" aria-controls="staticBackdrop"><img src="Icons/1641920-ffffff.svg" alt="" style="height: 20px;">
                    <span class="quantidade"> 0</span></li>
                </div>
